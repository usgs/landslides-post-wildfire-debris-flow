...
<div>
	...
	<p>
		...
		a given storm by combining the following two equations:
	</p>
	...
	<p>
		(2) x = -5.22 + (0.003 &#215 ElevRange) + (0.008 &#215 HM50<sub>pct</sub>) +
		(0.024 &#215 bslp<sub>pct</sub>) + (-0.007 &#215 CC<sub>pct</sub>) +
		(0.105 &#215 i30)
	</p>
	...
	<p>
		...
		<ul>
			...
			<li>
				HM50<sub>pct</sub> - is the percentage of the upstream watershed that was burned
				at high or moderate severity and has slope values in excess of 50
				percent (in percent),
			</li>
			<li>
				bslp<sub>pct</sub> - is the average gradient of the burned pixels upslope of the
				point (in percent),
			</li>
			<li>
				CC<sub>pct</sub> - is the average clay content of the soils in the basin (in
				percent) (Schwartz and Alexander, 1995), and
			</li>
			<li>
				i30 - is the spatially averaged upslope 30-min rainfall intensity for
	...
	<p>
		...
		equation 3 is used to calculate x:
	</p>

	<p>
		(3) x = -0.7 + (0.03 &#215 Slp30<sub>pct</sub>) - (1.6 &#215 Rugged) +
		(0.06 &#215 HM<sub>pct</sub>) + (0.2 &#215 CC<sub>pct</sub>) – (0.4 &#215
		LL<sub>pct</sub>) + (0.07 &#215 i60)
	</p>
	...
	<p>
		...
		<ul>
			<li>
				Slp30<sub>pct</sub> – is the percentage area of the upstream area with slope gradients
				in excess of 30 percent (in percent),
			</li>
			<li>
				Rugged – is the upslope ruggedness, which is equal to the total relief
				(in meters) of the upstream area divided by the square root of the total
				upslope area above the pixel (in square meters),
			</li>
			<li>
				HM<sub>pct</sub> - is the percentage of the upstream watershed that was burned at high
				or moderate severity (in percent),
			</li>
			<li>
				CC<sub>pct</sub> - is the average clay content of the soils in the basin (in percent)
				(Schwartz and Alexander, 1995),
			</li>
			<li>
				LL<sub>pct</sub> - is the average liquid limit of the soils in the basin (in percent)
				(Schwartz and Alexander, 1995), and
			</li>
			<li>
				i60 - is the spatially averaged upslope 60-min rainfall intensity for the
	...
	<p>
		(4) ln(V) = 2.89 + (0.17 &#215; sqrt(ElevRange)) + (0.3 &times;
		ln(HM<sub>km</sub>) + (0.47 &times; sqrt(i15))
	</p>
	...
	<p>
		...
		volume is calculated with equation 5:
	</p>

	<p>
		(5) ln(V) = 7.5 + (0.6 &#215; ln(Slp30<sub>km</sub>)) + (0.7 &#215;
		sqrt(HM<sub>km</sub>)) + (0.2 &#215; sqrt(r60))
	</p>
	...
	<p>
		...
		<ul>
			<li>
				Slp30<sub>km</sub> is the area upstream that has slope gradients in excess
				of 30 percent (in km<sup>2</sup>),
			</li>
			<li>
				HM<sub>km</sub> is the area upstream of the calculation point that was
				burned at high or
				moderate severity (in km<sup>2</sup>), and
			</li>
			<li>
				r60 is the spatially averaged 60-minute rainfall accumulation for the
				design storm in the upstream watershed (in mm).
			</li>
		</ul>
	</p>
