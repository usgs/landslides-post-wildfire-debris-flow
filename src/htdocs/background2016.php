...
<div>
  <p>
    ...
    described <a href="/hazards/postfire_debrisflow/background.php">here</a>.
  </p>
  <p>
  ...
  <ul class="referencelist">
    ...
    <!---<li>
      ...
      Youberg, A.M., In Review, Prediction of spatially explicit rainfall
      intensity-duration thresholds for post-fire debris-flow generation in the
      western United States.  Submitted to Geomorphology.
    </li>--->
    <li>
